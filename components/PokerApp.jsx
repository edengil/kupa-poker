...
function aggregate(recs, aliases) {
  ...
  return Object.entries(acc).map(([name, amount]) => ({
    name,
    amount
...
function yearTotals(db, y) {
  ...
  return {
    totals: aggregate(db.sessions.filter(s => s.y === y), A),
    official: false
  };
}
function monthTotals(db, y, mo) {
  return aggregate(db.sessions.filter(s => s.y === y && s.mo === mo), AL(db));
}
function allTimeTotals(db) {
  const ys = new Set([...db.sessions.map(s => s.y), ...db.yearly.map(y => y.y)]);
  const acc = {};
  for (const y of ys) for (const t of yearTotals(db, y).totals) acc[t.name] = r2((acc[t.name] || 0) + t.amount);
  return Object.entries(acc).map(([name, amount]) => ({
    name,
    amount
  })).sort((a, b) => b.amount - a.amount);
...
function Banner({
  ...
  const label = scope === "all" ? "כל הזמן" : scope === "year" ? `${y}` : `${MONTHS[mo - 1]} ${y}`;
  return /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, [["month", "חודש"], ["year", "שנה"], ["all", "הכל"]].map(([v, l]) => /*#__PURE__*/React.createElement("button", {
    key: v,
    onClick: () => setScope(v),
    style: {
      border: "none",
  ...
  }, l))), scope === "month" && periods.length > 0 ? /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "center",
      gap: 6
  ...
  }, label), /*#__PURE__*/React.createElement(NavBtn, {
  ...
  }, official && /*#__PURE__*/React.createElement(Award, {
    size: 14,
    color: C.brass
  }), label)), totals.length === 0 ? /*#__PURE__*/React.createElement("div", {
    style: {
      color: C.dim,
      fontSize: 13,
      padding: "6px 0"
    }
  }, "\u05D0\u05D9\u05DF \u05E0\u05EA\u05D5\u05E0\u05D9\u05DD") : /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 7,
      overflowX: "auto",
  ...
  }, i === 0 && t.amount > 0 && /*#__PURE__*/React.createElement(Crown, {
    size: 12,
    color: C.brass
  }), t.name), /*#__PURE__*/React.createElement("b", {
    style: {
      fontSize: 15,
      color: t.amount >= 0 ? C.win : C.loss,
      fontVariantNumeric: "tabular-nums"
    }
  }, fmt(t.amount))))), official && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 8,
      fontSize: 11.5,
      color: C.brass,
...
function InputTab({
  ...
  function save() {
    ...
    commit(next);
    setText("");
    setToast(kind === "session" ? `נשמר ערב ${date.d}.${date.mo}` : kind === "month" ? `נשמר ${MONTHS[month - 1]} ${year}` : `נשמר מאזן שנתי ${year}`);
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    value: kind,
    onChange: setKind,
    options: [["session", "ערב"], ["month", "חודש"], ["year", "שנתי"]]
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 8,
  ...
  }, kind === "month" && /*#__PURE__*/React.createElement(Select, {
    value: month,
    onChange: setMonth,
  ...
  }), kind === "year" && /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 12.5,
      color: C.brass,
      marginTop: 8
    }
  }, "\u05DE\u05D0\u05D6\u05DF \u05E9\u05E0\u05EA\u05D9 \u05D2\u05D5\u05D1\u05E8 \u05E2\u05DC \u05E1\u05DB\u05D5\u05DD \u05D4\u05E2\u05E8\u05D1\u05D9\u05DD \u05D1\u05D0\u05D5\u05EA\u05D4 \u05E9\u05E0\u05D4."), entries.length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 12
    }
  }, kind === "session" && /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "center",
      gap: 8,
    ...
    size: 16
  }), date ? /*#__PURE__*/React.createElement("span", null, "\u05E2\u05E8\u05D1 ", /*#__PURE__*/React.createElement("b", null, date.d, ".", date.mo, ".", date.y)) : /*#__PURE__*/React.createElement("span", null, "\u05DC\u05D0 \u05D6\u05D5\u05D4\u05D4 \u05EA\u05D0\u05E8\u05D9\u05DA \u2014 \u05D4\u05D5\u05E1\u05E3 \u05E9\u05D5\u05E8\u05D4 \"\u05E1\u05D9\u05DB\u05D5\u05DD \u05E4\u05D5\u05E7\u05E8 1.8\"")), kind !== "year" && /*#__PURE__*/React.createElement(BalanceMeter, {
    bal: bal
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 10,
  ...
  }, canon(e.name, AL(db)), e.combined && /*#__PURE__*/React.createElement(Tag, null, "\u05D6\u05D5\u05D2?")), /*#__PURE__*/React.createElement("b", {
    style: {
    ...
    size: 17
  }), toast), /*#__PURE__*/React.createElement(AliasCard, {
    db: db,
    commit: commit
...
function TableTab({
  ...
  const title = scope === "all" ? "כל הזמן" : scope === "year" ? `${y}` : `${MONTHS[mo - 1]} ${y}`;
  return /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 4
    }
    ...
    value: scope,
    onChange: setScope,
    options: [["month", "חודשי"], ["year", "שנתי"], ["all", "כל הזמן"]]
  ...
  }, scope === "month" && /*#__PURE__*/React.createElement(Select, {
    value: mo,
    onChange: setMo,
    options: MONTHS.map((m, i) => [i + 1, m]),
    label: "\u05D7\u05D5\u05D3\u05E9",
    ...
    size: 16,
    color: C.brass
  }), "\u05E1\u05D9\u05DB\u05D5\u05DD \u2014 ", title), totals.length > 0 && /*#__PURE__*/React.createElement(IconBtn, {
    onClick: () => setShare(true)
  }, /*#__PURE__*/React.createElement(Share2, {
    size: 15
  }))), totals.length === 0 ? /*#__PURE__*/React.createElement(Empty, {
  ...
  }, official ? "מאזן שנתי רשמי — גובר על סכום הערבים." : `מ־${recCount} ערבים.`, yearHasOfficial && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("br", null), "\u05E9\u05D9\u05DD \u05DC\u05D1: \u05DC\u05E9\u05E0\u05D4 \u05D6\u05D5 \u05D9\u05E9 \u05DE\u05D0\u05D6\u05DF \u05E9\u05E0\u05EA\u05D9 \u05E8\u05E9\u05DE\u05D9; \u05D4\u05D7\u05D5\u05D3\u05E9\u05D9\u05DD \u05DC\u05D0 \u05D1\u05D4\u05DB\u05E8\u05D7 \u05DE\u05E1\u05EA\u05DB\u05DE\u05D9\u05DD \u05D0\u05DC\u05D9\u05D5."))), share && /*#__PURE__*/React.createElement(ShareSheet, {
...
function Ledger({
  ...
  }, top && /*#__PURE__*/React.createElement(Crown, {
    size: 14,
    color: C.brass
  ...
  }, winners.length > 0 && /*#__PURE__*/React.createElement(GroupLabel, null, "\u05DE\u05E8\u05D5\u05D5\u05D9\u05D7\u05D9\u05DD"), winners.map((t, i) => /*#__PURE__*/React.createElement(Row, {
    key: t.name,
    t: t,
    top: i === 0
  ...
  }, /*#__PURE__*/React.createElement(GroupLabel, null, "\u05DE\u05E4\u05E1\u05D9\u05D3\u05D9\u05DD")), losers.map(t => /*#__PURE__*/React.createElement(Row, {
    key: t.name,
    t: t
  ...
  }, /*#__PURE__*/React.createElement("span", null, official ? "סה\"כ רשמי" : "בדיקת סגירה"), /*#__PURE__*/React.createElement("span", {
    style: {
      fontVariantNumeric: "tabular-nums"
    }
...
function AliasCard({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    size: 16
  }), "\u05DB\u05D9\u05E0\u05D5\u05D9\u05D9\u05DD / \u05D0\u05D9\u05D7\u05D5\u05D3 \u05E9\u05DE\u05D5\u05EA (", entries.length, ")"), /*#__PURE__*/React.createElement(ChevronDown, {
    size: 17,
    style: {
  ...
  }, "\u05DC\u05DE\u05E9\u05DC \"\u05D3\u05D5\" \u2190 \"\u05D3\u05DF \u05D9\u05E0\u05E7\u05DC\u05D5\u05D9\u05E5\". \u05D4\u05E9\u05DD \u05D4\u05E9\u05DE\u05D0\u05DC\u05D9 \u05D9\u05D5\u05DE\u05E8 \u05DC\u05D9\u05DE\u05E0\u05D9 \u05D1\u05DB\u05DC \u05D4\u05D7\u05D9\u05E9\u05D5\u05D1\u05D9\u05DD."), /*#__PURE__*/React.createElement("div", {
    style: {
      maxHeight: 200,
      overflowY: "auto"
    }
  ...
  }, "\u2190"), " ", /*#__PURE__*/React.createElement("b", null, v)), /*#__PURE__*/React.createElement(IconBtn, {
    onClick: () => rm(k),
    danger: true
  }, /*#__PURE__*/React.createElement(Trash2, {
    size: 14
...
function BackupCard({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    size: 16
  }), "\u05D2\u05D9\u05D1\u05D5\u05D9 \u05D5\u05D9\u05D9\u05D1\u05D5\u05D0"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 12,
      color: C.dim,
      marginTop: 0,
  ...
  }, "\u05D9\u05D9\u05E6\u05D0 \u05E7\u05D5\u05D1\u05E5 \u05DC\u05D2\u05D9\u05D1\u05D5\u05D9 \u05D0\u05D5 \u05DC\u05D4\u05E2\u05D1\u05E8\u05D4 \u05D1\u05D9\u05DF \u05D4\u05D0\u05E8\u05D8\u05D9\u05E4\u05E7\u05D8 \u05DC\u05D0\u05EA\u05E8 \u05D4-Netlify. \u05D4\u05D9\u05D9\u05D1\u05D5\u05D0 \u05D4\u05D5\u05D0 \u05D4\u05D3\u05E8\u05DA \u05D4\u05D0\u05DE\u05D9\u05E0\u05D4 \u05DC\u05D8\u05E2\u05D5\u05DF \u05E0\u05EA\u05D5\u05E0\u05D9\u05DD \u05E7\u05D9\u05D9\u05DE\u05D9\u05DD."), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 8
    }
    ...
    size: 16
  }), "\u05D9\u05D9\u05E6\u05D5\u05D0"), /*#__PURE__*/React.createElement("button", {
    ...
    size: 16
  }), "\u05D9\u05D9\u05D1\u05D5\u05D0"), /*#__PURE__*/React.createElement("input", {
    ref: fileRef,
    type: "file",
...
function Select({
  ...
  return /*#__PURE__*/React.createElement("label", {
    ...
    key: v,
    value: v
  }, l))), /*#__PURE__*/React.createElement(ChevronDown, {
    size: 16,
    style: {
      position: "absolute",
      left: 10,
...
const Trash2 = mkIcon(/*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("path", {
  d: "M3 6h18M8 6V4h8v2M19 6l-1 14H6L5 6"
}), /*#__PURE__*/React.createElement("path", {
  d: "M10 11v6M14 11v6"
})));
const AlertTriangle = mkIcon(/*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("path", {
  d: "M10.3 3.9 1.8 18a2 2 0 0 0 1.7 3h17a2 2 0 0 0 1.7-3L13.7 3.9a2 2 0 0 0-3.4 0z"
}), /*#__PURE__*/React.createElement("path", {
  d: "M12 9v4M12 17h.01"
})));
const CheckCircle2 = mkIcon(/*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("circle", {
  cx: "12",
  cy: "12",
  r: "10"
}), /*#__PURE__*/React.createElement("path", {
...
const CalendarDays = mkIcon(/*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("rect", {
  x: "3",
  y: "4",
  width: "18",
  height: "18",
...
const Pencil = mkIcon(/*#__PURE__*/React.createElement("path", {
  d: "M17 3a2.8 2.8 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5z"
}));
const Users = mkIcon(/*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("path", {
...
const ChevronDown = mkIcon(/*#__PURE__*/React.createElement("path", {
  d: "m6 9 6 6 6-6"
}));
const ChevronLeft = mkIcon(/*#__PURE__*/React.createElement("path", {
  d: "m15 18-6-6 6-6"
}));
const ChevronRight = mkIcon(/*#__PURE__*/React.createElement("path", {
  d: "m9 18 6-6-6-6"
}));
const Crown = mkIcon(/*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("path", {
  d: "M2 6l4 5 6-8 6 8 4-5v12H2z"
})));
const Plus = mkIcon(/*#__PURE__*/React.createElement("path", {
  d: "M12 5v14M5 12h14"
}));
const Minus = mkIcon(/*#__PURE__*/React.createElement("path", {
  d: "M5 12h14"
}));
const Share2 = mkIcon(/*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("circle", {
  cx: "18",
  cy: "5",
  r: "3"
}), /*#__PURE__*/React.createElement("circle", {
...
const Copy = mkIcon(/*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("rect", {
  x: "9",
  y: "9",
  width: "13",
  height: "13",
...
const TrendingUp = mkIcon(/*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("path", {
...
const Award = mkIcon(/*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("circle", {
  ...
  d: "M15.5 13.5 17 22l-5-3-5 3 1.5-8.5"
})));
const Send = mkIcon(/*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("path", {
  d: "M22 2 11 13"
}), /*#__PURE__*/React.createElement("path", {
  d: "M22 2l-7 20-4-9-9-4z"
})));
const Download = mkIcon(/*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("path", {
  d: "M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"
}), /*#__PURE__*/React.createElement("path", {
  d: "M7 10l5 5 5-5M12 15V3"
})));
const Upload = mkIcon(/*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("path", {
  d: "M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"
}), /*#__PURE__*/React.createElement("path", {
  d: "M17 8l-5-5-5 5M12 3v12"
})));
const UserPlus = mkIcon(/*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("path", {
  d: "M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"
}), /*#__PURE__*/React.createElement("circle", {
  cx: "9",
  cy: "7",
...
const Coins = mkIcon(/*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("circle", {
  cx: "8",
  cy: "8",
  r: "6"
}), /*#__PURE__*/React.createElement("path", {
  d: "M18.1 10.4a6 6 0 1 1-8.7 7.7"
}), /*#__PURE__*/React.createElement("path", {
  d: "M7 6h1v4M16.7 16H18v4"
})));
const ClipboardPaste = mkIcon(/*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("path", {
...
const PlayCircle = mkIcon(/*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("circle", {
  cx: "12",
  cy: "12",
  r: "10"
}), /*#__PURE__*/React.createElement("path", {
...
const BarChart3 = mkIcon(/*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("path", {
  d: "M3 3v18h18"
}), /*#__PURE__*/React.createElement("path", {
  d: "M7 16v-5M12 16V8M17 16v-3"
})));
