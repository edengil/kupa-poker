...
/** נרשם להתראות ושומר את המנוי בטבלה, צמוד לחשבון הגוגל ולשחקן. מחזיר "subscribed" או סיבת כישלון. */
export async function subscribePush(supabase, groupId, user, playerName = null) {
